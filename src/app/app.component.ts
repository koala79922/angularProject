      ...
      if (event instanceof NavigationEnd) {
        switch (event.urlAfterRedirects) {
          case '/':
            ...
            break;
          case '/' + RoutesConfig.routesNames.itemCards.basePath:
            this.title.setTitle('itemCards list');
            this.meta.updateTag({
              name: 'description',
              content: this.i18n({value: 'itemCards meta description', id: '@@itemCardsMetaDescription'})
            });
            break;
        }
      }
