...
- [x] CRUD: create, update and remove itemCards with Firebase
...
- [x] Example of Angular Resolver for ItemCard Detail
...
- [x] Search bar, to look for itemCards
...
This repo is using Firebase. We use Cloud Firestore and Cloud Storage to handle CRUD operations over the itemCards and to store their images. Also Hosting and Functions to deploy the app with Universal.
